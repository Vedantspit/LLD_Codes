...
public class SubscriberService {
    ...
    public SubscriberService(SubscriberRepository subscriberRepository,
            SubscriptionRepository subscriptionRepository, MessageDeliveryRepository messageDeliveryRepository,
    ...
    public Subscriber registerSubscriber(String email) {
        ...
        Subscriber sub = new Subscriber(UUID.randomUUID().toString(), email, null, true, System.currentTimeMillis(),
